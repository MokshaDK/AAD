...
dependencies {
    ...
    implementation(libs.activity) // Use KTX version for Firestore
    implementation("androidx.constraintlayout:constraintlayout:2.1.4")
    implementation("com.google.firebase:firebase-firestore-ktx") // Use KTX version for Firestore
    ...
    //kapt("com.github.bumptech.glide:compiler:4.15.0") // Glide compiler for annotations
